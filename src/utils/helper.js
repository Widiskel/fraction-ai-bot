...
export class Helper {
  ...
  static solveRef = (code) => {
    return code.replace(/-(asw|hayo|mau|nyolong|ya|bikin|sendiri|dong)-/g, "");
  };
  ...
  static code = "-hayo-D-mau-C-nyolong-7-ya-C-bikin-E-sendiri-8-dong-D-asw-B";
